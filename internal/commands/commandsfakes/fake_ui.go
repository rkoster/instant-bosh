...
type FakeUI struct {
	...
	AskForConfirmationWithLabelStub        func(string) error
	askForConfirmationWithLabelMutex       sync.RWMutex
	askForConfirmationWithLabelArgsForCall []struct {
		arg1 string
	}
	askForConfirmationWithLabelReturns struct {
		result1 error
	}
	askForConfirmationWithLabelReturnsOnCall map[int]struct {
		result1 error
	}
...
func (fake *FakeUI) AskForConfirmationWithLabel(arg1 string) error {
	fake.askForConfirmationWithLabelMutex.Lock()
	ret, specificReturn := fake.askForConfirmationWithLabelReturnsOnCall[len(fake.askForConfirmationWithLabelArgsForCall)]
	fake.askForConfirmationWithLabelArgsForCall = append(fake.askForConfirmationWithLabelArgsForCall, struct {
		arg1 string
	}{arg1})
	stub := fake.AskForConfirmationWithLabelStub
	fakeReturns := fake.askForConfirmationWithLabelReturns
	fake.recordInvocation("AskForConfirmationWithLabel", []interface{}{arg1})
	fake.askForConfirmationWithLabelMutex.Unlock()
	if stub != nil {
		return stub(arg1)
	}
	if specificReturn {
...
func (fake *FakeUI) AskForConfirmationWithLabelCallCount() int {
	fake.askForConfirmationWithLabelMutex.RLock()
	defer fake.askForConfirmationWithLabelMutex.RUnlock()
	return len(fake.askForConfirmationWithLabelArgsForCall)
}

func (fake *FakeUI) AskForConfirmationWithLabelCalls(stub func(string) error) {
	fake.askForConfirmationWithLabelMutex.Lock()
	defer fake.askForConfirmationWithLabelMutex.Unlock()
	fake.AskForConfirmationWithLabelStub = stub
}

func (fake *FakeUI) AskForConfirmationWithLabelArgsForCall(i int) string {
	fake.askForConfirmationWithLabelMutex.RLock()
	defer fake.askForConfirmationWithLabelMutex.RUnlock()
	argsForCall := fake.askForConfirmationWithLabelArgsForCall[i]
	return argsForCall.arg1
}

func (fake *FakeUI) AskForConfirmationWithLabelReturns(result1 error) {
	fake.askForConfirmationWithLabelMutex.Lock()
	defer fake.askForConfirmationWithLabelMutex.Unlock()
	fake.AskForConfirmationWithLabelStub = nil
	fake.askForConfirmationWithLabelReturns = struct {
		result1 error
	}{result1}
}

func (fake *FakeUI) AskForConfirmationWithLabelReturnsOnCall(i int, result1 error) {
	fake.askForConfirmationWithLabelMutex.Lock()
	defer fake.askForConfirmationWithLabelMutex.Unlock()
	fake.AskForConfirmationWithLabelStub = nil
	if fake.askForConfirmationWithLabelReturnsOnCall == nil {
		fake.askForConfirmationWithLabelReturnsOnCall = make(map[int]struct {
			result1 error
		})
	}
	fake.askForConfirmationWithLabelReturnsOnCall[i] = struct {
		result1 error
	}{result1}
}
