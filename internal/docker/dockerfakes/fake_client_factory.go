...
type FakeClientFactory struct {
	NewClientStub        func(logger.Logger, string) (*docker.Client, error)
...
func (fake *FakeClientFactory) NewClient(arg1 logger.Logger, arg2 string) (*docker.Client, error) {
...
func (fake *FakeClientFactory) NewClientCallCount() int {
	fake.newClientMutex.RLock()
	defer fake.newClientMutex.RUnlock()
	return len(fake.newClientArgsForCall)
}

func (fake *FakeClientFactory) NewClientCalls(stub func(logger.Logger, string) (*docker.Client, error)) {
	fake.newClientMutex.Lock()
	defer fake.newClientMutex.Unlock()
	fake.NewClientStub = stub
}

func (fake *FakeClientFactory) NewClientArgsForCall(i int) (logger.Logger, string) {
	fake.newClientMutex.RLock()
	defer fake.newClientMutex.RUnlock()
...
func (fake *FakeClientFactory) NewClientReturns(result1 *docker.Client, result2 error) {
	fake.newClientMutex.Lock()
	defer fake.newClientMutex.Unlock()
...
func (fake *FakeClientFactory) NewClientReturnsOnCall(i int, result1 *docker.Client, result2 error) {
	fake.newClientMutex.Lock()
	defer fake.newClientMutex.Unlock()
	fake.NewClientStub = nil
...
var _ docker.ClientFactory = new(FakeClientFactory)
